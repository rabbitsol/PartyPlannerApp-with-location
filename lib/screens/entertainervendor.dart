...
class EntertainerVendor extends StatefulWidget {
  const EntertainerVendor({super.key});
  @override
  State<EntertainerVendor> createState() => _EntertainerVendorState();
}

class _EntertainerVendorState extends State<EntertainerVendor> {
            ...
            press: () {
              setState(() {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) =>
                        const ChatScreen(txt1: "first", txt2: "Entertainers")));
              });
            },
          ),
                ...
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const ChatScreen(
                          txt1: "planner", txt2: "Entertainers")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const ChatScreen(
                          txt1: "service provider", txt2: "Entertainers")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
