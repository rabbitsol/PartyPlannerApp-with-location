...
class CakeVendor extends StatefulWidget {
  const CakeVendor({super.key});
  @override
  State<CakeVendor> createState() => _CakeVendorState();
}

class _CakeVendorState extends State<CakeVendor> {
            ...
            press: () {
              setState(() {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) =>
                        const ChatScreen(txt1: "first", txt2: "Cake")));
              });
            },
          ),
          ...
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          const ChatScreen(txt1: "planner", txt2: "Cake")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
                ...
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const ChatScreen(
                          txt1: "service provider", txt2: "Cake")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          const ChatScreen(txt1: "third", txt2: "Cake")));
                });
              }),
          const SizedBox(height: 40),
        ]),
