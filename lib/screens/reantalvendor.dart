...
class RentalVendor extends StatefulWidget {
  const RentalVendor({super.key});
  @override
  State<RentalVendor> createState() => _RentalVendorState();
}

class _RentalVendorState extends State<RentalVendor> {
            ...
            press: () {
              setState(() {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) =>
                        const ChatScreen(txt1: "first", txt2: "Rentals")));
              });
            },
          ),
          ...
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          const ChatScreen(txt1: "planner", txt2: "Rentals")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
                ...
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const ChatScreen(
                          txt1: "service provider", txt2: "Rentals")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          const ChatScreen(txt1: "third", txt2: "Rentals")));
                });
              }),
          const SizedBox(height: 40),
        ]),
