...
class BalloonVendor extends StatefulWidget {
  const BalloonVendor({super.key});
  @override
  State<BalloonVendor> createState() => _BalloonVendorState();
}

class _BalloonVendorState extends State<BalloonVendor> {
            ...
            press: () {
              setState(() {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) =>
                        const ChatScreen(txt1: "first", txt2: "Balloons")));
              });
            },
          ),
          ...
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          const ChatScreen(txt1: "planner", txt2: "Balloons")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
                ...
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const ChatScreen(
                          txt1: "service provider", txt2: "Balloons")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) =>
                          const ChatScreen(txt1: "third", txt2: "Balloons")));
                });
              }),
          const SizedBox(height: 40),
        ]),
