...
class PhotographerVendor extends StatefulWidget {
  const PhotographerVendor({super.key});
  @override
  State<PhotographerVendor> createState() => _PhotographerVendorState();
}

class _PhotographerVendorState extends State<PhotographerVendor> {
          ...
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const ChatScreen(
                          txt1: "planner", txt2: "Photographers")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
              ...
              press: () {
                setState(() {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const ChatScreen(
                          txt1: "service provider", txt2: "Photographers")));
                });
              }),
          const SizedBox(height: 40),
          CarouselSlidersWidget(
